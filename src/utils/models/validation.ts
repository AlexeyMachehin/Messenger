export enum ValidationError {
  ...
  FirstName = "Invalid Name. Latin or Cyrillic, the first letter must be uppercase, without spaces and without numbers, there are no special characters (only a hyphen is allowed)",
  SecondName = "Invalid Surname. Latin or Cyrillic, the first letter must be uppercase, without spaces and without numbers, there are no special characters (only a hyphen is allowed)",
